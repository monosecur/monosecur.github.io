...
define('CONTACTFORM_FROM_ADDRESS', 'darkside.monolith+monosecur@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Mono Secur');
...
define('CONTACTFORM_TO_ADDRESS', 'darkside.monolith+monosecur@gmail.com');
define('CONTACTFORM_TO_NAME', 'Mono Secur');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'darkside.monolith+monosecur@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'kvtjguknaeaptcks');
